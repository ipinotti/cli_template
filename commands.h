...
void show_x25_forward(const char *);
void show_x25_map(const char *);
void show_x25_routes(const char *);
void show_x25_svc(const char *);
void x25_param(const char *);
void x25_route_interface(const char *);
void x25_route_xot(const char *);
void dump_x25_routes(FILE *);
int get_procx25_val(const char *parm);
void dump_x25(FILE *);
void interface_x25_address(const char *);
void interface_x25_debug(const char *);
void interface_x25_facility_called_ae(const char *);
void interface_x25_facility_calling_ae(const char *);
void interface_x25_facility_packetsize(const char *);
void interface_x25_facility_reverse(const char *);
void interface_x25_facility_throughput(const char *);
void interface_x25_facility_windowsize(const char *);
void interface_x25_idle(const char *);
void interface_x25_ips(const char *cmdline);
void interface_x25_vc(const char *);
void interface_x25_modulo(const char *);
void interface_x25_ops(const char *cmdline);
void interface_x25_suppresscallingaddress(const char *cmdline);
void interface_x25_win(const char *cmdline);
void interface_x25_wout(const char *cmdline);
void dump_x25_config(FILE *, char *);
void interface_x25_map(const char *);
