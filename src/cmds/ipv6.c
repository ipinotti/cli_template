...
cish_command CMD_IPV6_ROUTE4_ETHERNET[] = {
	{CLI_STRING_ETH_IFACES, "Ethernet interface number", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};

cish_command CMD_IPV6_ROUTE4_LOOPBACK[] = {
	{"0-0", "Loopback interface number", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};

cish_command CMD_IPV6_ROUTE4_TUNNEL[] = {
	{"0-9", "Tunnel interface number", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};
#ifdef OPTION_MODEM3G
cish_command CMD_IPV6_ROUTE4_3G[] = {
	{"0-2", "3G interface number", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};
#endif

cish_command CMD_IPV6_ROUTE4_PPTP[] = {
	{"0-0", "PPTP interface number", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};

cish_command CMD_IPV6_ROUTE4_PPPOE[] = {
	{"0-0", "PPPoE interface number", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};
...
cish_command CMD_IPV6_ROUTE3[] = {
	...
	{"<ipv6address>", "Forwarding router's address", CMD_IPV6_ROUTE5, zebra_execute_cmd, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};

cish_command CMD_IPV6_ROUTE2[] = {
	{"<netmask>", "Destination prefix mask", CMD_IPV6_ROUTE3, NULL, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};

cish_command CMD_IPV6_ROUTE1[] = {
	{"<ipv6address>", "Destination prefix", CMD_IPV6_ROUTE2, NULL, 1, MSK_NORMAL},
	{NULL,NULL,NULL,NULL,0}
};
